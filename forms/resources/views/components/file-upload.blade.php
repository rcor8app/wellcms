...
>
    <div
        ...
        @else
            x-load
        @endif
        x-load-src="{{ \WellCMS\Support\Facades\WellCMSAsset::getAlpineComponentSrc('file-upload', 'wellcms/forms') }}"
        x-data="fileUploadFormComponent({
                    ...
                    confirmSvgEditingMessage: @js(__('wellcms-forms::components.file_upload.editor.svg.messages.confirmation')),
                    disabledSvgEditingMessage: @js(__('wellcms-forms::components.file_upload.editor.svg.messages.disabled')),
                            ...
                            <div class="flex-1 overflow-hidden">
                                ...
                                >
                                    <div class="flex-1 overflow-auto">
                                        <div class="space-y-6 p-4">
                                            <div class="w-full space-y-3">
                                                @foreach ([
                                                    [
                                                        'label' => __('wellcms-forms::components.file_upload.editor.fields.x_position.label'),
                                                        'ref' => 'xPositionInput',
                                                        'unit' => __('wellcms-forms::components.file_upload.editor.fields.x_position.unit'),
                                                        'alpineSaveHandler' => 'editor.setData({...editor.getData(true), x: +$el.value})',
                                                    ],
                                                    [
                                                        'label' => __('wellcms-forms::components.file_upload.editor.fields.y_position.label'),
                                                        'ref' => 'yPositionInput',
                                                        'unit' => __('wellcms-forms::components.file_upload.editor.fields.y_position.unit'),
                                                        'alpineSaveHandler' => 'editor.setData({...editor.getData(true), y: +$el.value})',
                                                    ],
                                                    [
                                                        'label' => __('wellcms-forms::components.file_upload.editor.fields.width.label'),
                                                        'ref' => 'widthInput',
                                                        'unit' => __('wellcms-forms::components.file_upload.editor.fields.width.unit'),
                                                        'alpineSaveHandler' => 'editor.setData({...editor.getData(true), width: +$el.value})',
                                                    ],
                                                    [
                                                        'label' => __('wellcms-forms::components.file_upload.editor.fields.height.label'),
                                                        'ref' => 'heightInput',
                                                        'unit' => __('wellcms-forms::components.file_upload.editor.fields.height.unit'),
                                                        'alpineSaveHandler' => 'editor.setData({...editor.getData(true), height: +$el.value})',
                                                    ],
                                                    [
                                                        'label' => __('wellcms-forms::components.file_upload.editor.fields.rotation.label'),
                                                        'ref' => 'rotationInput',
                                                        'unit' => __('wellcms-forms::components.file_upload.editor.fields.rotation.unit'),
                                            ...
                                            @if (count($aspectRatios = $getImageEditorAspectRatiosForJs()))
                                                <div class="space-y-3">
                                                    ...
                                                    >
                                                        {{ __('wellcms-forms::components.file_upload.editor.aspect_ratios.label') }}
                                                    </div>
                                                    ...
                                                    @foreach (collect($aspectRatios)->chunk(5) as $ratiosChunk)
                                                        ...
                                                        >
                                                            @foreach ($ratiosChunk as $label => $ratio)
                                                                <x-wellcms::button
                                                                    :x-tooltip="'{ content: ' . \Illuminate\Support\Js::from(__('wellcms-forms::components.file_upload.editor.actions.set_aspect_ratio.label', ['ratio' => $label])) . ', theme: $store.theme }'"
                                    ...
                                    >
                                        ...
                                        >
                                            {{ __('wellcms-forms::components.file_upload.editor.actions.cancel.label') }}
                                        </x-wellcms::button>
                                        ...
                                        <x-wellcms::button
                                            ...
                                            class="ml-auto"
                                        >
                                            {{ __('wellcms-forms::components.file_upload.editor.actions.reset.label') }}
                                        </x-wellcms::button>
                                        ...
                                        >
                                            {{ __('wellcms-forms::components.file_upload.editor.actions.save.label') }}
                                        </x-wellcms::button>
                                    </div>
                                </div>
                            </div>
