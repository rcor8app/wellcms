    ...
    >
        <div
            ...
            @else
                x-load
            @endif
            x-load-src="{{ \WellCMS\Support\Facades\WellCMSAsset::getAlpineComponentSrc('tags-input', 'wellcms/forms') }}"
        ...
        >
            <x-wellcms::input
                ...
                type="text"
                x-bind="input"
                :attributes="\WellCMS\Support\prepare_inherited_attributes($getExtraInputAttributeBag())"
            />
