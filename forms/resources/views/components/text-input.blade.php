@php
    use WellCMS\Forms\Components\TextInput\Actions\HidePasswordAction;
    use WellCMS\Forms\Components\TextInput\Actions\ShowPasswordAction;
            ...
            :attributes="
                \WellCMS\Support\prepare_inherited_attributes($getExtraInputAttributeBag())
                    ...
                    ->merge([
                        ...
                        'x-mask' . ($mask instanceof \WellCMS\Support\RawJs ? ':dynamic' : '') => filled($mask) ? $mask : null,
                    ], escape: false)
                    ->class([
