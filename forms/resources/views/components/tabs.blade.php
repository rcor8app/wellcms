@php
    use WellCMS\Forms\Components\Tabs\Tab;
...
<div
    ...
    {{
        $attributes
            ->merge([
                'id' => $getId(),
                'wire:key' => "{$this->getId()}.{$getStatePath()}." . \WellCMS\Forms\Components\Tabs::class . '.container',
            ], escape: false)
            ->merge($getExtraAttributes(), escape: false)
            ->merge($getExtraAlpineAttributes(), escape: false)
            ->class([
                're-fo-tabs flex flex-col',
...
>
    ...
    <x-wellcms::tabs :contained="$isContained" :label="$getLabel()">
