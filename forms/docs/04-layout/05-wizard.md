...
Alternatively, you can use the built-in WellCMS button Blade component:
...
Inside `afterValidation()` or `beforeValidation()`, you may throw `WellCMS\Support\Exceptions\Halt`, which will prevent the wizard from loading the next step:
