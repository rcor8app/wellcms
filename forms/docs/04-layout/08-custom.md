...
<LaracastsBanner
    ...
    url="https://laracasts.com/series/build-advanced-components-for-wellcms/episodes/7"
...
```php
use WellCMS\Forms\Components\View;

View::make('wellcms.forms.components.wizard')
```

This assumes that you have a `resources/views/wellcms/forms/components/wizard.blade.php` file.
...
{
    protected string $view = 'wellcms.forms.components.wizard';
...
It will also create a view file at `resources/views/wellcms/forms/components/wizard.blade.php`.
