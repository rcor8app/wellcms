...
```php
use WellCMS\Forms\Components\TagsInput;
...
> WellCMS also supports [`spatie/laravel-tags`](https://github.com/spatie/laravel-tags). See our [plugin documentation](https://wellcmsphp.com/plugins/wellcms-spatie-tags) for more information.
