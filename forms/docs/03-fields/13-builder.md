...
Builder::make('content')
    ...
    ->blocks([
        Block::make('heading')
            ...
            ->preview('wellcms.content.block-previews.heading'),
    ])
```

In `/resources/views/wellcms/content/block-previews/heading.blade.php`, you can access the block data like so:
