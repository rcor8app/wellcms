...
Field classes can be found in the `WellCMS\Form\Components` namespace.
...
WellCMS ships with many types of field, suitable for editing different types of data:
