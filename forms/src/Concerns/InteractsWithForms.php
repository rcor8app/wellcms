...
namespace WellCMS\Forms\Concerns;
...
use WellCMS\Support\Concerns\ResolvesDynamicLivewireProperties;
...
trait InteractsWithForms
{
     ...
     */
    public function getWellCMSTranslatableContentDriver(): ?string
    {
        return null;
    }
    ...
    {
        $driver = $this->getWellCMSTranslatableContentDriver();
    ...
    public function updatingInteractsWithForms(string $statePath): void
    {
        ...
        // https://github.com/wellcmsphp/wellcms/pull/13973
