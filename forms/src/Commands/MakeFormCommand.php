...
namespace WellCMS\Forms\Commands;
...
class MakeFormCommand extends Command
{
    ...
    protected $description = 'Create a new Livewire component containing a WellCMS form';
    ...
    public function handle(): int
    {
        ...
        $this->components->info("WellCMS form [{$path}] created successfully.");
