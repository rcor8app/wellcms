...
trait CanBeSearchable
{
    ...
    {
        return $this->evaluate($this->noSearchResultsMessage) ?? __('wellcms-forms::components.select.no_search_results_message');
    }

    public function getSearchPrompt(): string | Htmlable
    {
        return $this->evaluate($this->searchPrompt) ?? __('wellcms-forms::components.select.search_prompt');
    }
    ...
    {
        return $this->evaluate($this->searchingMessage) ?? __('wellcms-forms::components.select.searching_message');
    }
