...
class KeyValue extends Field
{
     ...
     * @var view-string
     */
    protected string $view = 'wellcms-forms::components.key-value';
    ...
    public function getDeleteAction(): Action
    {
        $action = Action::make($this->getDeleteActionName())
            ->label(__('wellcms-forms::components.key_value.actions.delete.label'))
            ->icon(WellCMSIcon::resolve('forms::components.key-value.actions.delete') ?? 'heroicon-m-trash')
            ->color('danger')
            ->livewireClickHandlerEnabled(false)
            ->iconButton()
    ...
    public function getReorderAction(): Action
    {
        $action = Action::make($this->getReorderActionName())
            ->label(__('wellcms-forms::components.key_value.actions.reorder.label'))
            ->icon(WellCMSIcon::resolve('forms::components.key-value.actions.reorder') ?? 'heroicon-m-arrows-up-down')
            ->color('gray')
            ->livewireClickHandlerEnabled(false)
            ->iconButton()
            ->size(ActionSize::Small)
    ...
    {
        return $this->evaluate($this->addActionLabel) ?? __('wellcms-forms::components.key_value.actions.add.label');
    }

    public function getDeleteActionLabel(): string
    {
        return $this->evaluate($this->deleteActionLabel) ?? __('wellcms-forms::components.key_value.actions.delete.label');
    }

    public function getReorderActionLabel(): string
    {
        return $this->evaluate($this->reorderActionLabel) ?? __('wellcms-forms::components.key_value.actions.reorder.label');
    }

    public function getKeyLabel(): string
    {
        return $this->evaluate($this->keyLabel) ?? __('wellcms-forms::components.key_value.fields.key.label');
    }

    public function getValueLabel(): string
    {
        return $this->evaluate($this->valueLabel) ?? __('wellcms-forms::components.key_value.fields.value.label');
    }
