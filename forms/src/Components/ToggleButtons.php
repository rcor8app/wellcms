...
class ToggleButtons extends Field implements Contracts\CanDisableOptions
{
    ...
    public const GROUPED_VIEW = 'wellcms-forms::components.toggle-buttons.grouped';
     ...
     * @var view-string
     */
    protected string $view = 'wellcms-forms::components.toggle-buttons.index';
    ...
    {
        $this->options([
            1 => $trueLabel ?? __('wellcms-forms::components.toggle_buttons.boolean.true'),
            0 => $falseLabel ?? __('wellcms-forms::components.toggle_buttons.boolean.false'),
        ]);
        ...
        $this->icons([
            1 => WellCMSIcon::resolve('forms::components.toggle-buttons.boolean.true') ?? 'heroicon-m-check',
            0 => WellCMSIcon::resolve('forms::components.toggle-buttons.boolean.false') ?? 'heroicon-m-x-mark',
        ]);
