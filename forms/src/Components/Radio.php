...
class Radio extends Field implements Contracts\CanDisableOptions
{
     ...
     * @var view-string
     */
    protected string $view = 'wellcms-forms::components.radio';
    ...
    {
        $this->options([
            1 => $trueLabel ?? __('wellcms-forms::components.radio.boolean.true'),
            0 => $falseLabel ?? __('wellcms-forms::components.radio.boolean.false'),
        ]);
