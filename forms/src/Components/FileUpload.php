...
class FileUpload extends BaseFileUpload
{
     ...
     * @var view-string
     */
    protected string $view = 'wellcms-forms::components.file-upload';
    ...
    public function getImageEditorAspectRatiosForJs(): array
    {
        return collect($this->evaluate($this->imageEditorAspectRatios) ?? [])
            ...
            ->mapWithKeys(fn (?string $ratio): array => [
                $ratio ?? __('wellcms-forms::components.file_upload.editor.aspect_ratios.no_fixed.label') => $this->normalizeImageCroppingRatioForJs($ratio),
            ])
    ...
    public function getImageEditorActions(string $iconSizeClasses): array
    {
        return [
            'zoom' => [
                ...
                [
                    'label' => __('wellcms-forms::components.file_upload.editor.actions.zoom_in.label'),
                    'iconHtml' => svg(WellCMSIcon::resolve('forms::components.file-upload.editor.actions.zoom-in') ?? 'heroicon-m-magnifying-glass-plus', $iconSizeClasses)->toHtml(),
                    'alpineClickHandler' => 'editor.zoom(0.1)',
                ],
                [
                    'label' => __('wellcms-forms::components.file_upload.editor.actions.zoom_out.label'),
                    'iconHtml' => svg(WellCMSIcon::resolve('forms::components.file-upload.editor.actions.zoom-out') ?? 'heroicon-m-magnifying-glass-minus', $iconSizeClasses)->toHtml(),
                    'alpineClickHandler' => 'editor.zoom(-0.1)',
                ],
                [
                    'label' => __('wellcms-forms::components.file_upload.editor.actions.zoom_100.label'),
                    'iconHtml' => svg(WellCMSIcon::resolve('forms::components.file-upload.editor.actions.zoom-100') ?? 'heroicon-m-arrows-pointing-out', $iconSizeClasses)->toHtml(),
                    'alpineClickHandler' => 'editor.zoomTo(1)',
                ],
            ],
            'move' => [
                [
                    'label' => __('wellcms-forms::components.file_upload.editor.actions.move_left.label'),
                    'iconHtml' => svg(WellCMSIcon::resolve('forms::components.file-upload.editor.actions.move-left') ?? 'heroicon-m-arrow-left-circle', $iconSizeClasses)->toHtml(),
                    'alpineClickHandler' => 'editor.move(-10, 0)',
                ],
                [
                    'label' => __('wellcms-forms::components.file_upload.editor.actions.move_right.label'),
                    'iconHtml' => svg(WellCMSIcon::resolve('forms::components.file-upload.editor.actions.move-right') ?? 'heroicon-m-arrow-right-circle', $iconSizeClasses)->toHtml(),
                    'alpineClickHandler' => 'editor.move(10, 0)',
                ],
                [
                    'label' => __('wellcms-forms::components.file_upload.editor.actions.move_up.label'),
                    'iconHtml' => svg(WellCMSIcon::resolve('forms::components.file-upload.editor.actions.move-up') ?? 'heroicon-m-arrow-up-circle', $iconSizeClasses)->toHtml(),
                    'alpineClickHandler' => 'editor.move(0, -10)',
                ],
                [
                    'label' => __('wellcms-forms::components.file_upload.editor.actions.move_down.label'),
                    'iconHtml' => svg(WellCMSIcon::resolve('forms::components.file-upload.editor.actions.move-down') ?? 'heroicon-m-arrow-down-circle', $iconSizeClasses)->toHtml(),
                    'alpineClickHandler' => 'editor.move(0, 10)',
                ],
            ],
            'transform' => [
                [
                    'label' => __('wellcms-forms::components.file_upload.editor.actions.rotate_left.label'),
                    'iconHtml' => svg(WellCMSIcon::resolve('forms::components.file-upload.editor.actions.rotate-left') ?? 'heroicon-m-arrow-uturn-left', $iconSizeClasses)->toHtml(),
                    'alpineClickHandler' => 'editor.rotate(-90)',
                ],
                [
                    'label' => __('wellcms-forms::components.file_upload.editor.actions.rotate_right.label'),
                    'iconHtml' => svg(WellCMSIcon::resolve('forms::components.file-upload.editor.actions.rotate-right') ?? 'heroicon-m-arrow-uturn-right', $iconSizeClasses)->toHtml(),
                    'alpineClickHandler' => 'editor.rotate(90)',
                ],
                [
                    'label' => __('wellcms-forms::components.file_upload.editor.actions.flip_horizontal.label'),
                ...
                [
                    'label' => __('wellcms-forms::components.file_upload.editor.actions.flip_vertical.label'),
