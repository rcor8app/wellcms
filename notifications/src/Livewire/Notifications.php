...
namespace WellCMS\Notifications\Livewire;

use WellCMS\Notifications\Collection;
...
class Notifications extends Component
{
    ...
    public bool $isWellCMSNotificationsComponent = true;
    ...
    {
        foreach (session()->pull('wellcms.notifications') ?? [] as $notification) {
    ...
    {
        if (($notification['format'] ?? null) !== 'wellcms') {
            return;
        }
    ...
    {
        return view('wellcms-notifications::notifications');
    }
}
