...
<x-wellcms::modal
    ...
    close-button
    :description="$hasNotifications ? null : __('wellcms-notifications::database.modal.empty.description')"
    :heading="$hasNotifications ? null : __('wellcms-notifications::database.modal.empty.heading')"
...
>
    @if ($hasNotifications)
        <x-slot name="header">
            <div>
                <x-wellcms-notifications::database.modal.heading
                    :unread-notifications-count="$unreadNotificationsCount"
                />

                <x-wellcms-notifications::database.modal.actions
        ...
        @if ($isPaginated)
            <x-slot name="footer">
                <x-wellcms::pagination :paginator="$notifications" />
            </x-slot>
        @endif
    @endif
</x-wellcms::modal>
