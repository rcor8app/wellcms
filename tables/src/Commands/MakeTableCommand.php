...
namespace WellCMS\Tables\Commands;
...
class MakeTableCommand extends Command
{
    ...
    protected $description = 'Create a new Livewire component containing a WellCMS table';
    ...
    public function handle(): int
    {
        ...
        $this->components->info("WellCMS table [{$path}] created successfully.");
