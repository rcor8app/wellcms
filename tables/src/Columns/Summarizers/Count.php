...
namespace WellCMS\Tables\Columns\Summarizers;
...
class Count extends Summarizer
{
    ...
    public function icons(bool $condition = true): static
    {
        ...
        $this->view('wellcms-tables::columns.summaries.icon-count');
    ...
    {
        return $this->hasIcons ? null : __('wellcms-tables::table.summary.summarizers.count.label');
    }
