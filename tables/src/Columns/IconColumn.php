...
class IconColumn extends Column
{
     ...
     * @var view-string
     */
    protected string $view = 'wellcms-tables::columns.icon-column';
    ...
    public function getFalseIcon(): string
    {
        return $this->evaluate($this->falseIcon)
            ?? WellCMSIcon::resolve('tables::columns.icon-column.false')
            ?? 'heroicon-o-x-circle';
    }
    ...
    public function getTrueIcon(): string
    {
        return $this->evaluate($this->trueIcon)
            ?? WellCMSIcon::resolve('tables::columns.icon-column.true')
