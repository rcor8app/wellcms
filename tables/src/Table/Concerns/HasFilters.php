...
trait HasFilters
{
    ...
    public function getFiltersTriggerAction(): Action
    {
        $action = Action::make('openFilters')
            ->label(__('wellcms-tables::table.actions.filter.label'))
            ->iconButton()
            ->icon(WellCMSIcon::resolve('tables::actions.filter') ?? 'heroicon-m-funnel')
            ->color('gray')
            ...
            ->extraModalFooterActions([
                ...
                Action::make('resetFilters')
                    ->label(__('wellcms-tables::table.filters.actions.reset.label'))
                    ->color('danger')
                    ->action('resetTableFiltersForm')
                    ->button(),
            ])
            ->modalCancelActionLabel(__('wellcms::components/modal.actions.close.label'))
            ->table($this);
    ...
    public function getFiltersApplyAction(): Action
    {
        $action = Action::make('applyFilters')
            ->label(__('wellcms-tables::table.filters.actions.apply.label'))
