...
class TrashedFilter extends TernaryFilter
{
    ...
    protected function setUp(): void
    {
        ...
        $this->label(__('wellcms-tables::table.filters.trashed.label'));

        $this->placeholder(__('wellcms-tables::table.filters.trashed.without_trashed'));

        $this->trueLabel(__('wellcms-tables::table.filters.trashed.with_trashed'));

        $this->falseLabel(__('wellcms-tables::table.filters.trashed.only_trashed'));
