...
namespace WellCMS\Tables\Filters\QueryBuilder\Constraints\Operators;
...
class IsFilledOperator extends Operator
{
    ...
    public function getLabel(): string
    {
        return __(
            $this->isInverse() ?
                    'wellcms-tables::filters/query-builder.operators.is_filled.label.inverse' :
                    'wellcms-tables::filters/query-builder.operators.is_filled.label.direct',
        );
    }
    ...
    public function getSummary(): string
    {
        return __(
            $this->isInverse() ?
                    'wellcms-tables::filters/query-builder.operators.is_filled.summary.inverse' :
                    'wellcms-tables::filters/query-builder.operators.is_filled.summary.direct',
