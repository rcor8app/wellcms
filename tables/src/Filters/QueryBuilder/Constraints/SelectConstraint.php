...
use WellCMS\Tables\Filters\Concerns\HasOptions;
use WellCMS\Tables\Filters\QueryBuilder\Constraints\Operators\IsFilledOperator;
use WellCMS\Tables\Filters\QueryBuilder\Constraints\SelectConstraint\Operators\IsOperator;
...
class SelectConstraint extends Constraint
{
    ...
    protected function setUp(): void
    {
        ...
        $this->icon(WellCMSIcon::resolve('tables::filters.query-builder.constraints.select') ?? 'heroicon-m-chevron-up-down');
