...
class EndsWithOperator extends Operator
{
    ...
    public function getLabel(): string
    {
        return __(
            $this->isInverse() ?
                'wellcms-tables::filters/query-builder.operators.text.ends_with.label.inverse' :
                'wellcms-tables::filters/query-builder.operators.text.ends_with.label.direct',
        );
    }
    ...
    public function getSummary(): string
    {
        return __(
            $this->isInverse() ?
                'wellcms-tables::filters/query-builder.operators.text.ends_with.summary.inverse' :
                'wellcms-tables::filters/query-builder.operators.text.ends_with.summary.direct',
            [
