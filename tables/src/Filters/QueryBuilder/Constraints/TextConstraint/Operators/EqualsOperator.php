...
class EqualsOperator extends Operator
{
    ...
    public function getLabel(): string
    {
        return __(
            $this->isInverse() ?
                'wellcms-tables::filters/query-builder.operators.text.equals.label.inverse' :
                'wellcms-tables::filters/query-builder.operators.text.equals.label.direct',
        );
    }
    ...
    public function getSummary(): string
    {
        return __(
            $this->isInverse() ?
                'wellcms-tables::filters/query-builder.operators.text.equals.summary.inverse' :
                'wellcms-tables::filters/query-builder.operators.text.equals.summary.direct',
            [
