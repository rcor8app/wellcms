...
class ContainsOperator extends Operator
{
    ...
    public function getLabel(): string
    {
        return __(
            $this->isInverse() ?
                'wellcms-tables::filters/query-builder.operators.text.contains.label.inverse' :
                'wellcms-tables::filters/query-builder.operators.text.contains.label.direct',
        );
    }
    ...
    public function getSummary(): string
    {
        return __(
            $this->isInverse() ?
                'wellcms-tables::filters/query-builder.operators.text.contains.summary.inverse' :
                'wellcms-tables::filters/query-builder.operators.text.contains.summary.direct',
            [
