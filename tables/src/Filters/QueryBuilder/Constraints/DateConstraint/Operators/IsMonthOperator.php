...
class IsMonthOperator extends Operator
{
    ...
    public function getLabel(): string
    {
        return __(
            $this->isInverse() ?
                'wellcms-tables::filters/query-builder.operators.date.is_month.label.inverse' :
                'wellcms-tables::filters/query-builder.operators.date.is_month.label.direct',
        );
    }
    ...
    public function getSummary(): string
    {
        return __(
            $this->isInverse() ?
                'wellcms-tables::filters/query-builder.operators.date.is_month.summary.inverse' :
                'wellcms-tables::filters/query-builder.operators.date.is_month.summary.direct',
            [
    ...
    public function getFormSchema(): array
    {
        return [
            Select::make('month')
                ->label(__('wellcms-tables::filters/query-builder.operators.date.form.month.label'))
