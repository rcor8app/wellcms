...
class IsDateOperator extends Operator
{
    ...
    public function getLabel(): string
    {
        return __(
            $this->isInverse() ?
                'wellcms-tables::filters/query-builder.operators.date.is_date.label.inverse' :
                'wellcms-tables::filters/query-builder.operators.date.is_date.label.direct',
        );
    }
    ...
    public function getSummary(): string
    {
        return __(
            $this->isInverse() ?
                'wellcms-tables::filters/query-builder.operators.date.is_date.summary.inverse' :
                'wellcms-tables::filters/query-builder.operators.date.is_date.summary.direct',
            [
