...
namespace WellCMS\Tables\Filters\QueryBuilder\Constraints\NumberConstraint\Operators;
...
class IsMaxOperator extends Operator
{
    ...
    public function getLabel(): string
    {
        return __(
            $this->isInverse() ?
                'wellcms-tables::filters/query-builder.operators.number.is_max.label.inverse' :
                'wellcms-tables::filters/query-builder.operators.number.is_max.label.direct',
        );
    }
    ...
    public function getSummary(): string
    {
        return __(
            $this->isInverse() ?
                'wellcms-tables::filters/query-builder.operators.number.is_max.summary.inverse' :
                'wellcms-tables::filters/query-builder.operators.number.is_max.summary.direct',
            [
    ...
    public function getFormSchema(): array
    {
        return [
            TextInput::make('number')
                ->label(__('wellcms-tables::filters/query-builder.operators.number.form.number.label'))
                ->numeric()
