...
class EqualsOperator extends Operator
{
    ...
    public function getLabel(): string
    {
        return __(
            $this->isInverse() ?
                'wellcms-tables::filters/query-builder.operators.number.equals.label.inverse' :
                'wellcms-tables::filters/query-builder.operators.number.equals.label.direct',
        );
    }
    ...
    public function getSummary(): string
    {
        return __(
            $this->isInverse() ?
                'wellcms-tables::filters/query-builder.operators.number.equals.summary.inverse' :
                'wellcms-tables::filters/query-builder.operators.number.equals.summary.direct',
            [
