...
namespace WellCMS\Tables\Filters\QueryBuilder\Constraints\NumberConstraint\Operators\Concerns;

use Exception;
use WellCMS\Forms\Components\Select;
use WellCMS\Tables\Filters\QueryBuilder\Constraints\NumberConstraint;
...
trait CanAggregateRelationships
{
    ...
    protected function getAggregateSelect(): Select
    {
        return Select::make(static::getAggregateSelectName())
            ->label(__('wellcms-tables::filters/query-builder.operators.number.form.aggregate.label'))
            ->options([
                static::getAggregateSumKey() => __('wellcms-tables::filters/query-builder.operators.number.aggregates.sum.label'),
                static::getAggregateAverageKey() => __('wellcms-tables::filters/query-builder.operators.number.aggregates.average.label'),
                static::getAggregateMinKey() => __('wellcms-tables::filters/query-builder.operators.number.aggregates.max.label'),
                static::getAggregateMaxKey() => __('wellcms-tables::filters/query-builder.operators.number.aggregates.min.label'),
            ])
    ...
    protected function getAttributeLabel(): string
    {
        ...
        return __(match ($this->getAggregate()) {
            static::getAggregateAverageKey() => 'wellcms-tables::filters/query-builder.operators.number.aggregates.average.summary',
            static::getAggregateMaxKey() => 'wellcms-tables::filters/query-builder.operators.number.aggregates.max.summary',
            static::getAggregateMinKey() => 'wellcms-tables::filters/query-builder.operators.number.aggregates.min.summary',
            static::getAggregateSumKey() => 'wellcms-tables::filters/query-builder.operators.number.aggregates.sum.summary',
