...
class IsMinOperator extends Operator
{
    ...
    public function getLabel(): string
    {
        return __(
            $this->isInverse() ?
                'wellcms-tables::filters/query-builder.operators.number.is_min.label.inverse' :
                'wellcms-tables::filters/query-builder.operators.number.is_min.label.direct',
        );
    }
    ...
    public function getSummary(): string
    {
        return __(
            $this->isInverse() ?
                'wellcms-tables::filters/query-builder.operators.number.is_min.summary.inverse' :
                'wellcms-tables::filters/query-builder.operators.number.is_min.summary.direct',
            [
