...
use WellCMS\Tables\Filters\QueryBuilder\Constraints\RelationshipConstraint;
...
class IsRelatedToOperator extends Operator
{
    ...
    public function getLabel(): string
    {
        return __(
            $this->getConstraint()->isMultiple() ?
                (
                    $this->isInverse() ?
                        'wellcms-tables::filters/query-builder.operators.relationship.is_related_to.label.multiple.inverse' :
                        'wellcms-tables::filters/query-builder.operators.relationship.is_related_to.label.multiple.direct'
                ) :
                (
                    $this->isInverse() ?
                        'wellcms-tables::filters/query-builder.operators.relationship.is_related_to.label.single.inverse' :
                        'wellcms-tables::filters/query-builder.operators.relationship.is_related_to.label.single.direct'
                ),
        );
    }
    ...
    public function getSummary(): string
    {
        ...
        $values = $relationshipQuery
            ...
            ->join(glue: __('wellcms-tables::filters/query-builder.operators.relationship.is_related_to.summary.values_glue.0'), finalGlue: __('wellcms-tables::filters/query-builder.operators.relationship.is_related_to.summary.values_glue.final'));

        return __(
            $this->getConstraint()->isMultiple() ?
                (
                    $this->isInverse() ?
                        'wellcms-tables::filters/query-builder.operators.relationship.is_related_to.summary.multiple.inverse' :
                        'wellcms-tables::filters/query-builder.operators.relationship.is_related_to.summary.multiple.direct'
                ) :
                (
                    $this->isInverse() ?
                        'wellcms-tables::filters/query-builder.operators.relationship.is_related_to.summary.single.inverse' :
                        'wellcms-tables::filters/query-builder.operators.relationship.is_related_to.summary.single.direct'
                ),
            [
    ...
    public function getFormSchema(): array
    {
        ...
        $field = Select::make($constraint->isMultiple() ? 'values' : 'value')
            ->label(__($constraint->isMultiple() ? 'wellcms-tables::filters/query-builder.operators.relationship.is_related_to.form.values.label' : 'wellcms-tables::filters/query-builder.operators.relationship.is_related_to.form.value.label'))
