...
@php
    $getHiddenClasses = function (WellCMS\Tables\Columns\Column | WellCMS\Tables\Columns\Layout\Component $layoutComponent): ?string {
...
@foreach ($components as $layoutComponent)
    @php
        ...
        $isColumn = $layoutComponent instanceof \WellCMS\Tables\Columns\Column;
    @endphp
