...
@if ($hasPageSummary)
    ...
    >
        ...
        @if ($extraHeadingColumn)
            <x-wellcms-tables::summary.header-cell>
                {{ __('wellcms-tables::table.summary.heading', ['label' => $pluralModelLabel]) }}
            </x-wellcms-tables::summary.header-cell>
        @endif
    ...
    <x-wellcms-tables::summary.row
        ...
        :heading="__('wellcms-tables::table.summary.subheadings.page', ['label' => $pluralModelLabel])"
...
<x-wellcms-tables::summary.row
    ...
    :heading="__(($hasPageSummary ? 'wellcms-tables::table.summary.subheadings.all' : 'wellcms-tables::table.summary.heading'), ['label' => $pluralModelLabel])"
    :placeholder-columns="$placeholderColumns"
