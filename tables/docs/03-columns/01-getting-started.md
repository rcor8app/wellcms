...
<LaracastsBanner
    title="Table Columns"
    description="Watch the Rapid Laravel Development with WellCMS series on Laracasts - it will teach you the basics of adding columns to WellCMS resource tables."
    url="https://laracasts.com/series/rapid-laravel-development-with-wellcms/episodes/9"
    series="rapid-laravel-development"
/>

Column classes can be found in the `WellCMS\Tables\Columns` namespace. You can put them inside the `$table->columns()` method:
...
WellCMS ships with two main types of columns - static and editable.
