...
<LaracastsBanner
    title="Table Actions"
    description="Watch the Rapid Laravel Development with WellCMS series on Laracasts - it will teach you the basics of adding actions to WellCMS resource tables."
    url="https://laracasts.com/series/rapid-laravel-development-with-wellcms/episodes/11"
...
```php
use WellCMS\Tables\Actions\BulkAction;
use Illuminate\Database\Eloquent\Collection;
...
WellCMS includes several prebuilt actions and bulk actions that you can add to a table. Their aim is to simplify the most common Eloquent-related actions:
