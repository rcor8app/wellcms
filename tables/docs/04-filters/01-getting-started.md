...
<LaracastsBanner
    title="Table Filters"
    description="Watch the Rapid Laravel Development with WellCMS series on Laracasts - it will teach you the basics of adding filters to WellCMS resource tables."
    url="https://laracasts.com/series/rapid-laravel-development-with-wellcms/episodes/10"
...
Filters are built entirely on WellCMS's form fields. They can render any combination of form fields, which users can then interact with to filter the table.
...
use WellCMS\Tables\Filters\TernaryFilter;
...
```php
use WellCMS\Tables\Filters\BaseFilter;
