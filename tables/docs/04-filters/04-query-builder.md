...
To use it, you need to define a set of "constraints" that will be used to filter the data. WellCMS includes some built-in constraints, that follow common data types, but you can also define your own custom constraints.

You can add a query builder to any table using the `QueryBuilder` filter:

```php
use WellCMS\Tables\Filters\QueryBuilder;
use WellCMS\Tables\Filters\QueryBuilder\Constraints\BooleanConstraint;
use WellCMS\Tables\Filters\QueryBuilder\Constraints\DateConstraint;
...
use WellCMS\Tables\Filters\QueryBuilder\Constraints\SelectConstraint;
use WellCMS\Tables\Filters\QueryBuilder\Constraints\TextConstraint;
...
WellCMS ships with many different constraints that you can use out of the box. You can also [create your own custom constraints](#creating-custom-constraints):
