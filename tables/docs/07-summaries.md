...
```php
use WellCMS\Tables\Columns\Summarizers\Average;
use WellCMS\Tables\Columns\Summarizers\Range;
use WellCMS\Tables\Columns\TextColumn;
...
WellCMS ships with four types of summarizer:
...
use WellCMS\Tables\Columns\Summarizers\Count;
...
```php
use WellCMS\Tables\Columns\Summarizers\Sum;
use WellCMS\Tables\Columns\TextColumn;
...
```php
use WellCMS\Tables\Columns\Summarizers\Summarizer;
use WellCMS\Tables\Columns\TextColumn;
use Illuminate\Database\Query\Builder;
