...
@props([
    ...
    'ariaLabelledby' => null,
    'autofocus' => \WellCMS\Support\View\Components\Modal::$isAutofocused,
    'closeButton' => \WellCMS\Support\View\Components\Modal::$hasCloseButton,
    'closeByClickingAway' => \WellCMS\Support\View\Components\Modal::$isClosedByClickingAway,
    'closeByEscaping' => \WellCMS\Support\View\Components\Modal::$isClosedByEscaping,
...
@php
    ...
    $hasFooter = (! \WellCMS\Support\is_slot_empty($footer)) || (is_array($footerActions) && count($footerActions)) || (! is_array($footerActions) && (! \WellCMS\Support\is_slot_empty($footerActions)));
    $hasHeading = filled($heading);
    $hasIcon = filled($icon);
    $hasSlot = ! \WellCMS\Support\is_slot_empty($slot);
            ...
            >
                ...
                >
                    ...
                    @if ($hasFooter)
                        ...
                        >
                            @if (! \WellCMS\Support\is_slot_empty($footer))
                                {{ $footer }}
                            @else
                                <div
                                    @class([
