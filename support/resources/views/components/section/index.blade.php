...
<section
    {{-- TODO: Investigate Livewire bug - https://github.com/wellcmsphp/wellcms/pull/8511 --}}
    x-data="{
            ...
            <div class="flex items-center gap-3">
                ...
                @if ($hasHeading || $hasDescription)
                    <div class="grid flex-1 gap-y-1">
                        @if ($hasHeading)
                            <x-wellcms::section.heading>
                                {{ $heading }}
                            </x-wellcms::section.heading>
                        @endif

                        @if ($hasDescription)
                            <x-wellcms::section.description>
                                {{ $description }}
                            </x-wellcms::section.description>
                        @endif
                    </div>
                ...
                @if ($hasHeaderActions)
                    <div class="hidden sm:block">
                        <x-wellcms::actions
                            ...
                            :alignment="\WellCMS\Support\Enums\Alignment::Start"
                            x-on:click.stop=""
                        />
                    </div>
                @endif
