...
if (! function_exists('WellCMS\Support\format_money')) {
    /**
...
if (! function_exists('WellCMS\Support\format_number')) {
    /**
...
if (! function_exists('WellCMS\Support\get_model_label')) {
...
if (! function_exists('WellCMS\Support\locale_has_pluralization')) {
...
if (! function_exists('WellCMS\Support\get_color_css_variables')) {
    /**
    ...
    function get_color_css_variables(string | array | null $color, array $shades, ?string $alias = null): ?string
    {
        ...
        if ($alias !== null) {
            if (($overridingShades = WellCMSColor::getOverridingShades($alias)) !== null) {
                $shades = $overridingShades;
            }

            if ($addedShades = WellCMSColor::getAddedShades($alias)) {
                $shades = [...$shades, ...$addedShades];
            }

            if ($removedShades = WellCMSColor::getRemovedShades($alias)) {
...
if (! function_exists('WellCMS\Support\prepare_inherited_attributes')) {
...
if (! function_exists('WellCMS\Support\is_slot_empty')) {
...
if (! function_exists('WellCMS\Support\is_app_url')) {
...
if (! function_exists('WellCMS\Support\generate_href_html')) {
    function generate_href_html(?string $url, bool $shouldOpenInNewTab = false, ?bool $shouldOpenInSpaMode = null): Htmlable
    {
        ...
        if ($shouldOpenInNewTab) {
            $html .= ' target="_blank"';
        } elseif ($shouldOpenInSpaMode ?? (WellCMSView::hasSpaMode($url))) {
            $html .= ' wire:navigate';
        }
...
if (! function_exists('WellCMS\Support\generate_search_column_expression')) {
    /**
     * @internal This function is only to be used internally by WellCMS and is subject to change at any time. Please do not use this function in your own code.
     */
...
if (! function_exists('WellCMS\Support\generate_search_term_expression')) {
    /**
     * @internal This function is only to be used internally by WellCMS and is subject to change at any time. Please do not use this function in your own code.
     */
