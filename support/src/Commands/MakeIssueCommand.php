...
#[AsCommand(name: 'make:wellcms-issue')]
class MakeIssueCommand extends Command
{
    protected $signature = 'make:wellcms-issue';

    protected $description = 'Generates a link to the WellCMS issue page and pre-fills the version numbers.';

    public function handle(): void
    {
        $url = 'https://github.com/wellcmsphp/wellcms/issues/new?' . http_build_query([
            'template' => 'bug_report.yml',
            'package-version' => InstalledVersions::getPrettyVersion('wellcms/support'),
