...
```blade
<x-wellcms::modal icon="heroicon-o-information-circle">
    <x-slot name="heading">
        Modal heading
    </x-slot>
...
```blade
<x-wellcms::modal alignment="center">
    {{-- Modal content --}}
</x-wellcms::modal>
```
...
```blade
<x-wellcms::modal :close-by-clicking-away="false">
    {{-- Modal content --}}
</x-wellcms::modal>
```
...
```blade
<x-wellcms::modal :close-by-escaping="false">
    {{-- Modal content --}}
</x-wellcms::modal>
```
...
```blade
<x-wellcms::modal :close-button="false">
    <x-slot name="heading">
        Modal heading
    </x-slot>
...
```blade
<x-wellcms::modal :autofocus="false">
    {{-- Modal content --}}
</x-wellcms::modal>
```
...
<x-wellcms::modal>
    <x-slot name="trigger" disabled>
        <x-wellcms::button :disabled="true">
            Open modal
        </x-wellcms::button>
    </x-slot>
    {{-- Modal content --}}
