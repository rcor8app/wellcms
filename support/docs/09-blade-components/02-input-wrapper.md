...
<x-wellcms::input.wrapper>
    <x-wellcms::input.select wire:model="status">
...
```blade
<x-wellcms::input.wrapper :valid="! $errors->has('name')">
    <x-wellcms::input
        type="text"
        wire:model="name"
    />
...
<div x-data="{ errors: ['name'] }">
    <x-wellcms::input.wrapper alpine-valid="! errors.includes('name')">
        <x-wellcms::input
            type="text"
            wire:model="name"
        />
...
```blade
<x-wellcms::input.wrapper disabled>
    <x-wellcms::input
        type="text"
        wire:model="name"
        disabled
...
```blade
<x-wellcms::input.wrapper suffix-icon="heroicon-m-globe-alt">
    <x-wellcms::input
        type="url"
        wire:model="domain"
    />
