@if ($this instanceof \WellCMS\Actions\Contracts\HasActions && (! $this->hasActionsModalRendered))
...
@if ($this instanceof \WellCMS\Tables\Contracts\HasTable && (! $this->hasTableModalRendered))
...
@if ($this instanceof \WellCMS\Infolists\Contracts\HasInfolists && (! $this->hasInfolistsModalRendered))
