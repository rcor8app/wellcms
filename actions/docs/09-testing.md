...
it('links to the correct WellCMS sites', function () {
    ...
    livewire(EditInvoice::class, [
        ...
        ->assertActionHasUrl('wellcms', 'https://wellcmsphp.com/')
        ->assertActionDoesNotHaveUrl('wellcms', 'https://github.com/wellcmsphp/wellcms')
        ->assertActionShouldOpenUrlInNewTab('wellcms')
