...
WellCMS includes a prebuilt action that is able to [replicate](https://laravel.com/docs/eloquent#replicating-models) Eloquent records. You may use it like so:
...
If you want to replicate table rows, you can use the `WellCMS\Tables\Actions\ReplicateAction` instead:

```php
use WellCMS\Tables\Actions\ReplicateAction;
