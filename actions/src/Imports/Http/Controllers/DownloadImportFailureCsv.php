...
namespace WellCMS\Actions\Imports\Http\Controllers;

use WellCMS\Actions\Imports\Models\FailedImportRow;
...
class DownloadImportFailureCsv
{
    public function __invoke(Import $import): StreamedResponse
    {
        ...
        $columnHeaders[] = __('wellcms-actions::import.failure_csv.error_header');
        ...
        $import->failedRows()
            ...
            ->each(fn (FailedImportRow $failedImportRow) => $csv->insertOne([
                ...
                'error' => $failedImportRow->validation_error ?? __('wellcms-actions::import.failure_csv.system_error'),
            ]));
        ...
        }, __('wellcms-actions::import.failure_csv.file_name', [
