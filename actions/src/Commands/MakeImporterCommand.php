...
#[AsCommand(name: 'make:wellcms-importer')]
class MakeImporterCommand extends Command
{
    ...
    protected $description = 'Create a new WellCMS importer class';

    protected $signature = 'make:wellcms-importer {name?} {--G|generate} {--F|force}';
    ...
    public function handle(): int
    {
        ...
        $namespace = 'App\\WellCMS\\Imports';
        $path = app_path('WellCMS/Imports/');
        ...
        $this->components->info("WellCMS importer [{$importerPath}] created successfully.");
