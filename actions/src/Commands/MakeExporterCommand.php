...
namespace WellCMS\Actions\Commands;
...
#[AsCommand(name: 'make:wellcms-exporter')]
class MakeExporterCommand extends Command
{
    ...
    protected $description = 'Create a new WellCMS exporter class';

    protected $signature = 'make:wellcms-exporter {name?} {--G|generate} {--F|force}';
    ...
    public function handle(): int
    {
        ...
        $namespace = 'App\\WellCMS\\Exports';
        $path = app_path('WellCMS/Exports/');
        ...
        $this->components->info("WellCMS exporter [{$exporterPath}] created successfully.");
