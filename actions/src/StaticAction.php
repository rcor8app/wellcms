...
class StaticAction extends ViewComponent implements Contracts\Groupable
{
    ...
    public const BADGE_VIEW = 'wellcms-actions::badge-action';

    public const BUTTON_VIEW = 'wellcms-actions::button-action';

    public const GROUPED_VIEW = 'wellcms-actions::grouped-action';

    public const ICON_BUTTON_VIEW = 'wellcms-actions::icon-button-action';

    public const LINK_VIEW = 'wellcms-actions::link-action';
