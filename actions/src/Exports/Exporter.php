...
namespace WellCMS\Actions\Exports;
...
abstract class Exporter
{
    ...
    {
        return __('wellcms-actions::export.notifications.completed.title');
    }
    ...
    {
        $disk = config('wellcms.default_filesystem_disk');
    ...
    {
        return __('wellcms-actions::export.file_name', [
