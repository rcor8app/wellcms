...
use WellCMS\Support\Components\ViewComponent;
...
class ActionGroup extends ViewComponent implements HasLivewire
{
    ...
    public const BADGE_VIEW = 'wellcms-actions::badge-group';

    public const BUTTON_VIEW = 'wellcms-actions::button-group';

    public const GROUPED_VIEW = 'wellcms-actions::grouped-group';

    public const ICON_BUTTON_VIEW = 'wellcms-actions::icon-button-group';

    public const LINK_VIEW = 'wellcms-actions::link-group';
    ...
    {
        $label = $this->evaluate($this->label) ?? __('wellcms-actions::group.trigger.label');
    ...
    {
        return $this->getBaseIcon() ?? WellCMSIcon::resolve('actions::action-group') ?? 'heroicon-m-ellipsis-vertical';
    }
