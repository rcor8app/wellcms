...
trait CanReplicateRecords
{
    ...
    protected function setUp(): void
    {
        ...
        $this->label(__('wellcms-actions::replicate.single.label'));

        $this->modalHeading(fn (): string => __('wellcms-actions::replicate.single.modal.heading', ['label' => $this->getRecordTitle()]));

        $this->modalSubmitActionLabel(__('wellcms-actions::replicate.single.modal.actions.replicate.label'));

        $this->successNotificationTitle(__('wellcms-actions::replicate.single.notifications.replicated.title'));
