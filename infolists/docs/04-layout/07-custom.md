...
<LaracastsBanner
    ...
    url="https://laracasts.com/series/build-advanced-components-for-wellcms/episodes/9"
...
```php
use WellCMS\Infolists\Components\View;

View::make('wellcms.infolists.components.box')
```

This assumes that you have a `resources/views/wellcms/infolists/components/box.blade.php` file.
...
{
    protected string $view = 'wellcms.infolists.components.box';
...
It will also create a view file at `resources/views/wellcms/infolists/components/box.blade.php`.
