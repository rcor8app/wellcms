...
Layout component classes can be found in the `WellCMS\Infolists\Components` namespace. They reside within the schema of your infolist, alongside any [entries](../entries/getting-started).
...
```php
use WellCMS\Infolists\Components\Grid;
...
```php
use WellCMS\Infolists\Components\Group;
