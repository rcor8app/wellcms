...
WellCMS's infolist package allows you to [render a read-only list of data about a particular entity](adding-an-infolist-to-a-livewire-component). It's also used within other WellCMS packages, such as the [Panel Builder](../panels) for displaying [app resources](../panels/resources/getting-started) and [relation managers](../panels/resources/relation-managers), as well as for [action modals](../actions). Learning the features of the Infolist Builder will be incredibly time-saving when both building your own custom Livewire applications and using WellCMS's other packages.

This guide will walk you through the basics of building infolists with WellCMS's infolist package. If you're planning to add a new infolist to your own Livewire component, you should [do that first](adding-an-infolist-to-a-livewire-component) and then come back. If you're adding an infolist to an [app resource](../panels/resources/getting-started), or another WellCMS package, you're ready to go!
...
```php
use WellCMS\Infolists\Components\Section;
use WellCMS\Infolists\Components\TextEntry;
...
```php
use WellCMS\Infolists\Components\ImageEntry;
use WellCMS\Infolists\Components\Section;
use WellCMS\Infolists\Components\TextEntry;
