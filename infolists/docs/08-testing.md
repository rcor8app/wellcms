...
it('links to the correct WellCMS sites', function () {
    ...
    livewire(EditInvoice::class, [
        ...
        ->assertInfolistActionHasUrl('customer', 'wellcms', 'https://wellcmsphp.com/')
        ->assertInfolistActionDoesNotHaveUrl('customer', 'wellcms', 'https://github.com/wellcmsphp/wellcms')
        ->assertInfolistActionShouldOpenUrlInNewTab('customer', 'wellcms')
