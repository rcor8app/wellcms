...
<LaracastsBanner
    ...
    url="https://laracasts.com/series/build-advanced-components-for-wellcms/episodes/8"
...
This assumes that you have a `resources/views/wellcms/infolists/entries/status-switcher.blade.php` file.
...
```php
use WellCMS\Infolists\Components\Entry;

class StatusSwitcher extends Entry
{
    protected string $view = 'wellcms.infolists.entries.status-switcher';
}
```

It will also create a view file at `resources/views/wellcms/infolists/entries/status-switcher.blade.php`.
