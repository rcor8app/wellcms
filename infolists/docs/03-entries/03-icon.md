...
```php
use WellCMS\Infolists\Components\IconEntry;
...
> If this column in the model class is already cast as a `bool` or `boolean`, WellCMS is able to detect this, and you do not need to use `boolean()` manually.
