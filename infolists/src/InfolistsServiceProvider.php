...
namespace WellCMS\Infolists;

use WellCMS\Infolists\Testing\TestsActions;
...
class InfolistsServiceProvider extends PackageServiceProvider
{
    ...
    protected function getCommands(): array
    {
        ...
        foreach ($commands as $command) {
            $class = 'WellCMS\\Infolists\\Commands\\Aliases\\' . class_basename($command);
