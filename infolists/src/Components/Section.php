...
use Closure;
use WellCMS\Support\Concerns\HasDescription;
use WellCMS\Support\Concerns\HasExtraAlpineAttributes;
use WellCMS\Support\Concerns\HasHeading;
use WellCMS\Support\Concerns\HasIcon;
use WellCMS\Support\Concerns\HasIconColor;
...
class Section extends Component implements Contracts\HasFooterActions, Contracts\HasHeaderActions
{
     ...
     * @var view-string
     */
    protected string $view = 'wellcms-infolists::components.section';
