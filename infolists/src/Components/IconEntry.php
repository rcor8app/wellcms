...
class IconEntry extends Entry
{
     ...
     * @var view-string
     */
    protected string $view = 'wellcms-infolists::components.icon-entry';
    ...
    public function getFalseIcon(): string
    {
        return $this->evaluate($this->falseIcon)
            ?? WellCMSIcon::resolve('infolists::components.icon-entry.false')
            ?? 'heroicon-o-x-circle';
    }
    ...
    public function getTrueIcon(): string
    {
        return $this->evaluate($this->trueIcon)
            ?? WellCMSIcon::resolve('infolists::components.icon-entry.true')
