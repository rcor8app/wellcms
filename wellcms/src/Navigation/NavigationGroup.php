...
use WellCMS\Support\Concerns\HasExtraSidebarAttributes;
use WellCMS\Support\Concerns\HasExtraTopbarAttributes;
...
class NavigationGroup extends Component
{
    ...
    {
        return (bool) ($this->evaluate($this->isCollapsible) ?? wellcms()->hasCollapsibleNavigationGroups());
    }
