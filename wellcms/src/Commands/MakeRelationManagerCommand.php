...
#[AsCommand(name: 'make:wellcms-relation-manager')]
class MakeRelationManagerCommand extends Command
{
    use CanIndentStrings;
    use CanManipulateFiles;

    protected $description = 'Create a new WellCMS relation manager class for a resource';

    protected $signature = 'make:wellcms-relation-manager {resource?} {relationship?} {recordTitleAttribute?} {--attach} {--associate} {--soft-deletes} {--view} {--panel=} {--F|force}';
    ...
    public function handle(): int
    {
        ...
        $this->components->info("WellCMS relation manager [{$path}] created successfully.");
