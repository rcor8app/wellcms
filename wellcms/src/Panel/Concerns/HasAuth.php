...
use WellCMS\Pages\Auth\EmailVerification\EmailVerificationPrompt;
use WellCMS\Pages\Auth\Login;
use WellCMS\Pages\Auth\PasswordReset\RequestPasswordReset;
use WellCMS\Pages\Auth\PasswordReset\ResetPassword;
use WellCMS\Pages\Auth\Register;
