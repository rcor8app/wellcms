...
use WellCMS\Livewire\DatabaseNotifications;
use WellCMS\Livewire\GlobalSearch;
use WellCMS\Livewire\Notifications;
use WellCMS\Pages\Auth\EditProfile;
use WellCMS\Pages\Page;
use WellCMS\Resources\Pages\Page as ResourcePage;
...
trait HasComponents
{
    ...
    {
        return (config('wellcms.cache_path') ?? base_path('bootstrap/cache/wellcms')) . DIRECTORY_SEPARATOR . 'panels' . DIRECTORY_SEPARATOR . "{$this->getId()}.php";
    }
}
