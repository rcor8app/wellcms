...
namespace WellCMS\Resources\RelationManagers;
...
use WellCMS\Support\Concerns\CanBeLazy;
...
class RelationManager extends Component implements Actions\Contracts\HasActions, Forms\Contracts\HasForms, Infolists\Contracts\HasInfolists, Tables\Contracts\HasTable
{
     ...
     * @var view-string
     */
    protected static string $view = 'wellcms-panels::resources.relation-manager';
