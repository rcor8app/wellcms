...
class CreateRecord extends Page
{
     ...
     * @var view-string
     */
    protected static string $view = 'wellcms-panels::resources.pages.create-record';
    ...
    {
        return static::$breadcrumb ?? __('wellcms-panels::resources/pages/create-record.breadcrumb');
    }
    ...
    {
        return $this->getCreatedNotificationMessage() ?? __('wellcms-panels::resources/pages/create-record.notifications.created.title');
    }
    ...
    protected function getCreateFormAction(): Action
    {
        return Action::make('create')
            ->label(__('wellcms-panels::resources/pages/create-record.form.actions.create.label'))
            ->submit('create')
            ->keyBindings(['mod+s']);
    }
    ...
    protected function getCreateAnotherFormAction(): Action
    {
        return Action::make('createAnother')
            ->label(__('wellcms-panels::resources/pages/create-record.form.actions.create_another.label'))
    ...
    protected function getCancelFormAction(): Action
    {
        return Action::make('cancel')
            ->label(__('wellcms-panels::resources/pages/create-record.form.actions.cancel.label'))
    ...
    public function getTitle(): string | Htmlable
    {
        ...
        return __('wellcms-panels::resources/pages/create-record.title', [
