...
use WellCMS\Actions\ReplicateAction;
use WellCMS\Actions\RestoreAction;
use WellCMS\Actions\ViewAction;
...
use WellCMS\Pages\Concerns\HasUnsavedDataChangesAlert;
...
class EditRecord extends Page
{
     ...
     * @var view-string
     */
    protected static string $view = 'wellcms-panels::resources.pages.edit-record';
    ...
    public static function getNavigationIcon(): string | Htmlable | null
    {
        return static::$navigationIcon
            ?? WellCMSIcon::resolve('panels::resources.pages.edit-record.navigation-item')
            ?? 'heroicon-o-pencil-square';
    }

    public function getBreadcrumb(): string
    {
        return static::$breadcrumb ?? __('wellcms-panels::resources/pages/edit-record.breadcrumb');
    }

    public function getContentTabLabel(): ?string
    {
        return __('wellcms-panels::resources/pages/edit-record.content.tab.label');
    }
    ...
    {
        return $this->getSavedNotificationMessage() ?? __('wellcms-panels::resources/pages/edit-record.notifications.saved.title');
    }
    ...
    public function getTitle(): string | Htmlable
    {
        ...
        return __('wellcms-panels::resources/pages/edit-record.title', [
    ...
    protected function getSaveFormAction(): Action
    {
        return Action::make('save')
            ->label(__('wellcms-panels::resources/pages/edit-record.form.actions.save.label'))
            ->submit('save')
            ->keyBindings(['mod+s']);
    }
    ...
    protected function getCancelFormAction(): Action
    {
        return Action::make('cancel')
            ->label(__('wellcms-panels::resources/pages/edit-record.form.actions.cancel.label'))
