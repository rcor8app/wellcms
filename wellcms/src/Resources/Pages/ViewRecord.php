...
use WellCMS\Actions\EditAction;
...
class ViewRecord extends Page
{
     ...
     * @var view-string
     */
    protected static string $view = 'wellcms-panels::resources.pages.view-record';
    ...
    public static function getNavigationIcon(): string | Htmlable | null
    {
        return static::$navigationIcon
            ?? WellCMSIcon::resolve('panels::resources.pages.view-record.navigation-item')
            ?? 'heroicon-o-eye';
    }

    public function getBreadcrumb(): string
    {
        return static::$breadcrumb ?? __('wellcms-panels::resources/pages/view-record.breadcrumb');
    }

    public function getContentTabLabel(): ?string
    {
        return __('wellcms-panels::resources/pages/view-record.content.tab.label');
    }
    ...
    public function getTitle(): string | Htmlable
    {
        ...
        return __('wellcms-panels::resources/pages/view-record.title', [
