...
use WellCMS\Resources\Concerns\InteractsWithRelationshipTable;
...
class ManageRelatedRecords extends Page implements Tables\Contracts\HasTable
{
     ...
     * @var view-string
     */
    protected static string $view = 'wellcms-panels::resources.pages.manage-related-records';
    ...
    public static function getNavigationIcon(): string | Htmlable | null
    {
        return static::$navigationIcon
            ?? WellCMSIcon::resolve('panels::resources.pages.manage-related-records.navigation-item')
