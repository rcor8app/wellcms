...
```php
use WellCMS\Resources\Components\Tab;
...
```php
use use WellCMS\Resources\Components\Tab;
...
```php
protected static string $view = 'wellcms.resources.users.pages.list-users';
```

This assumes that you have created a view at `resources/views/wellcms/resources/users/pages/list-users.blade.php`.
...
To see everything that the default view contains, you can check the `vendor/wellcms/wellcms/resources/views/resources/pages/list-records.blade.php` file in your project.
