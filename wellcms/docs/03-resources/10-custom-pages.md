...
WellCMS allows you to create completely custom pages for resources. To create a new page, you can use:

```bash
php artisan make:wellcms-page SortUsers --resource=UserResource --type=custom
```
...
use WellCMS\Resources\Pages\Concerns\InteractsWithRecord;
